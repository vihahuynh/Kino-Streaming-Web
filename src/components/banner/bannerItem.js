      ...
      <div className={classes.details}>
        ...
        <div>
          ...
          <span className={classes.info}>
            <svg>
              <use xlinkHref="%PUBLIC_URL%/sprite.svg#icon-dot-single"></use>
            </svg>
          </span>
        ...
        <div>
          ...
          >
            <svg>
              <use xlinkHref="%PUBLIC_URL%/sprite.svg#icon-controller-play"></use>
            </svg>
            <span className={classes["btn__text"]}>Play now</span>
          </Link>
          {/* <a className={`${classes.btn} ${classes["btn--info"]}`} href="/">
            <svg>
              <use xlinkHref="%PUBLIC_URL%/sprite.svg#icon-info-with-circle"></use>
            </svg>
